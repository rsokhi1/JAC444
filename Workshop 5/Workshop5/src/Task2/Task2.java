...
public class Task2 {
    ...
    public static void createTransRecordFile(){
        ...
        TransactionRecord[] trans = new TransactionRecord[7];
        trans[0] = new TransactionRecord(100,27.14);
        trans[1] = new TransactionRecord(300,62.11);
        trans[2] = new TransactionRecord(300,83.89);
        trans[3] = new TransactionRecord(400,100.56);
        trans[4] = new TransactionRecord(700,80.78);
        trans[5] = new TransactionRecord(700,1.53);
        trans[6] = new TransactionRecord(900,82.17);
